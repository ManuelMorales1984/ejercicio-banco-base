package com.banco.base.configuration;
...
public class SwaggerConfig {
    public static final String URL = "https://www.bancobase.com/";

    @Bean
    public Docket productApi() {
        return new Docket(DocumentationType.SWAGGER_2)
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.banco.base"))
    ...
    private ApiInfo getApiInfo(String version) {
        return new ApiInfo(
                ...
                "v".concat(version),
                URL,
                new Contact("Manuel Morales", URL, "manuel.morales@meltsan.com"),
                "Licencia -->  TESTING",
                URL,
